...
cpp_hprobit <- function(Xlist, Ylist, meanPrior, precPrior, ncat, gammaStart, betaStart, tune_start, adapt_tune, tune_window_size, target_acceptance_rate, iterations, burnin, thin, save_burnin_samples, seed, verbose) {
